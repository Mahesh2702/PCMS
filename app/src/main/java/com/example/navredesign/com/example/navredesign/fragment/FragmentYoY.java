...
public class FragmentYoY extends Fragment {
...
//    private static final String KEY_MOVIE_TITLE = "key_title";
     ...
     */
    public static FragmentYoY newInstance(String title) {
        FragmentYoY fragmentHome = new FragmentYoY();
...
//        args.putString(KEY_MOVIE_TITLE, title);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_yoy, container, false);
    }
