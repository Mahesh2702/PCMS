...
public class FragmentPopulation extends Fragment {
...
//    private static final String KEY_MOVIE_TITLE = "key_title";
     ...
     */
    public static FragmentPopulation newInstance(String title) {
        FragmentPopulation fragmentHome = new FragmentPopulation();
