...
public class FragmentMedicalCost extends Fragment {

//    private static final String KEY_MOVIE_TITLE = "key_title";

    public FragmentMedicalCost() {
     ...
     */
    public static FragmentMedicalCost newInstance(String title) {
        FragmentMedicalCost fragmentHome = new FragmentMedicalCost();
...
//        args.putString(KEY_MOVIE_TITLE, title);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_medical_cost, container, false);
    }
