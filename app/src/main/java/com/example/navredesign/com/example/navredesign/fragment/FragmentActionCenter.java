...
public class FragmentActionCenter extends Fragment {

//    private static final String KEY_MOVIE_TITLE = "key_title";

    public FragmentActionCenter() {
     ...
     */
    public static FragmentActionCenter newInstance(String title) {
        FragmentActionCenter fragmentHome = new FragmentActionCenter();
...
//        args.putString(KEY_MOVIE_TITLE, title);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_action_center, container, false);
    }
